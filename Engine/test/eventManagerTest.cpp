...
//   EXPECT_EQ(EventManager::getInstance().getEventQueue()->at(1)->getNextMillis(), 3);
//   EXPECT_EQ(EventManager::getInstance().getEventQueue()->at(2)->getNextMillis(), 2);
// }
...
//   Scheduler::getInstance().runFor(20);
//   EXPECT_EQ(singleShotCounter, 1);
// }
...
//   Scheduler::getInstance().runFor(2);
//   EXPECT_EQ(cyclicCounter, 0);

//   // Progress the simulation by 2 more milliseconds (making the time 5 milliseconds) and verify the event is
//   triggered Scheduler::getInstance().runFor(2); EXPECT_EQ(cyclicCounter, 1);

//   // Progress the simulation by 3 more milliseconds and verify the event is not yet triggered a second time
//   Scheduler::getInstance().runFor(3);
...
//   Scheduler::getInstance().runFor(5);
...
//   Scheduler::getInstance().runFor(4);
//   EXPECT_EQ(cyclicCounter, 3);
// }
...
//   Scheduler::getInstance().runFor(100);
